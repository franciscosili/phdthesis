...
\begin{figure}[ht!]
    ...
    \end{subfigure}
    \caption{Distribución del n\'umero de interacciones por bunch-crossing durante Run-2 (izquierda) y Run-3 (derecha).}
