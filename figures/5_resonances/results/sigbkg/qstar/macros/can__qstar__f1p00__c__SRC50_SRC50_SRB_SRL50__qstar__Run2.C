...
#endif
void can__qstar__f1p00__c__SRC50_SRC50_SRB_SRL50__qstar__Run2()
{
//=========Macro generated from canvas: c1/
//=========  (Wed Sep 25 19:08:55 2024) by ROOT version 6.32.02
...
// ------------>Primitives in pad: up
   ...
   entry=leg->AddEntry("tgraph2d__cStar__Nom__SRC50__phjet_m_obs_fy1p0","c*","PL");
   ...
   entry->SetTextFont(42);
   entry=leg->AddEntry("tgraph2d__cStar__Nom__SRC50_SRB_SRL50__phjet_m_obs_fy1p0","c*","PL");
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.5201005,0.72804,"c* Exp. limit = 3231.4 GeV");
   tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetTextSize(0.024);
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.5201005,0.70164,"c* Obs. limit = 3414.3 GeV");
   tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetTextSize(0.024);
   tex->SetLineWidth(2);
