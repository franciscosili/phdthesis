...
#endif
void can__qstar__q_b_c____qstar__SR_SRB_SRC50__Run2()
{
//=========Macro generated from canvas: c1/
//=========  (Wed Sep 25 17:17:25 2024) by ROOT version 6.32.02
...
// ------------>Primitives in pad: up
   ...
   chist__1->Draw("pe");
   TLatex *   tex = new TLatex(0.540201,0.30416,"#bf{#it{ATLAS}} #scale[1.0]{Internal}");
   tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetTextSize(0.04);
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.540201,0.34816,"#sqrt{s} = 13 TeV, 140.07 fb^{-1}");
   tex->SetNDC();
   tex->SetTextFont(42);
   ...
   TLegend *leg = new TLegend(0.540201,0.13608,0.879397,0.25488,NULL,"brNDC");
   leg->SetBorderSize(0);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("tgraph__cStar__Nom__SRC50__phjet_m_obs_intersection","SRC50, c*","L");
   ...
   leg = new TLegend(0.540201,0.26192,0.879397,0.29712,NULL,"brNDC");
   leg->SetBorderSize(0);
   ...
   entry->SetTextFont(42);
   leg->Draw();
      tex = new TLatex(0.540201,0.39216,"95% C.L. limits");
   tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetTextSize(0.032);
   tex->SetLineWidth(2);
   ...
   Double_t Graph2_fx7[49] = { 1421.053, 1481.413, 1605.263, 1676.544, 1789.474, 1854.623, 1973.684, 2001.712, 2115.871, 2157.895, 2216.07, 2299.647, 2342.105, 2375.956, 2460.137, 2513.732, 2526.316,
   ...
   Double_t Graph2_fy7[49] = { 0.2560675, 0.2705263, 0.3051285, 0.3226316, 0.3564447, 0.3747368, 0.4165438, 0.4268421, 0.4789474, 0.5031471, 0.5310526, 0.5831579, 0.6147867, 0.6352631, 0.6873684, 0.7394737, 0.7487249,
   ...
   graph = new TGraph(49,Graph2_fx7,Graph2_fy7);
   ...
   TH1F *Graph_Graph27 = new TH1F("Graph_Graph27","",100,1243.295,3376.389);
   Graph_Graph27->SetMinimum(0.09783524);
   Graph_Graph27->SetMaximum(1.082015);
   ...
   Double_t tgraph__cStar__Nom__SRC50__phjet_m_exp_intersection_fx8[25] = { 1421.053, 1433.861, 1605.263, 1681.093, 1789.474, 1905.424, 1973.684, 2079.887, 2157.895, 2218.157, 2320.717, 2342.105, 2425.345, 2515.154, 2526.316, 2597.281, 2682.237,
   2710.526, 2748.592, 2819.43, 2890.359, 2894.737, 2934.634, 2983.032, 3020.638 };
   Double_t tgraph__cStar__Nom__SRC50__phjet_m_exp_intersection_fy8[25] = { 0.2156644, 0.2184211, 0.2557974, 0.2705263, 0.2950594, 0.3226316, 0.3416047, 0.3747368, 0.40637, 0.4268421, 0.4789474, 0.4917272, 0.5310526, 0.5831579, 0.5915184, 0.6352631, 0.6873684,
   0.7123569, 0.7394737, 0.7915789, 0.8436842, 0.8516234, 0.8957894, 0.9478948, 1 };
   graph = new TGraph(25,tgraph__cStar__Nom__SRC50__phjet_m_exp_intersection_fx8,tgraph__cStar__Nom__SRC50__phjet_m_exp_intersection_fy8);
   ...
   TH1F *Graph_tgraph__cStar__Nom__SRC50__phjet_m_exp_intersection8 = new TH1F("Graph_tgraph__cStar__Nom__SRC50__phjet_m_exp_intersection8","",100,1261.094,3180.596);
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_exp_intersection8->SetMinimum(0.1372309);
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_exp_intersection8->SetMaximum(1.078434);
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_exp_intersection8->SetDirectory(nullptr);
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_exp_intersection8->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_exp_intersection8->SetLineColor(ci);
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_exp_intersection8->GetXaxis()->SetLabelFont(42);
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_exp_intersection8->GetXaxis()->SetTitleOffset(1);
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_exp_intersection8->GetXaxis()->SetTitleFont(42);
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_exp_intersection8->GetYaxis()->SetLabelFont(42);
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_exp_intersection8->GetYaxis()->SetTitleFont(42);
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_exp_intersection8->GetZaxis()->SetLabelFont(42);
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_exp_intersection8->GetZaxis()->SetTitleOffset(1);
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_exp_intersection8->GetZaxis()->SetTitleFont(42);
   graph->SetHistogram(Graph_tgraph__cStar__Nom__SRC50__phjet_m_exp_intersection8);
   
   graph->Draw(" lx");
   
   Double_t tgraph__cStar__Nom__SRC50__phjet_m_obs_intersection_fx9[24] = { 1421.053, 1605.263, 1789.474, 1973.684, 1987.317, 2108.794, 2157.895, 2276.945, 2342.105, 2389.633, 2422.494, 2462.839, 2526.316, 2561.119, 2710.526, 2800.365, 2894.737,
   2963.869, 3030.548, 3078.947, 3123.383, 3184.789, 3214.291, 3234.46 };
   Double_t tgraph__cStar__Nom__SRC50__phjet_m_obs_intersection_fy9[24] = { 0.270863, 0.29359, 0.3035397, 0.3181766, 0.3226316, 0.3747368, 0.3829072, 0.4268421, 0.4600882, 0.4789474, 0.5310526, 0.5831579, 0.6236326, 0.6352631, 0.6709542, 0.6873684, 0.718459,
   0.7394737, 0.7915789, 0.8159522, 0.8436842, 0.8957894, 0.9478948, 1 };
   graph = new TGraph(24,tgraph__cStar__Nom__SRC50__phjet_m_obs_intersection_fx9,tgraph__cStar__Nom__SRC50__phjet_m_obs_intersection_fy9);
   graph->SetName("tgraph__cStar__Nom__SRC50__phjet_m_obs_intersection");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_tgraph__cStar__Nom__SRC50__phjet_m_obs_intersection9 = new TH1F("Graph_tgraph__cStar__Nom__SRC50__phjet_m_obs_intersection9","",100,1239.712,3415.801);
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_obs_intersection9->SetMinimum(0.1979493);
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_obs_intersection9->SetMaximum(1.072914);
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_obs_intersection9->SetDirectory(nullptr);
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_obs_intersection9->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_obs_intersection9->SetLineColor(ci);
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_obs_intersection9->GetXaxis()->SetLabelFont(42);
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_obs_intersection9->GetXaxis()->SetTitleOffset(1);
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_obs_intersection9->GetXaxis()->SetTitleFont(42);
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_obs_intersection9->GetYaxis()->SetLabelFont(42);
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_obs_intersection9->GetYaxis()->SetTitleFont(42);
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_obs_intersection9->GetZaxis()->SetLabelFont(42);
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_obs_intersection9->GetZaxis()->SetTitleOffset(1);
   Graph_tgraph__cStar__Nom__SRC50__phjet_m_obs_intersection9->GetZaxis()->SetTitleFont(42);
   graph->SetHistogram(Graph_tgraph__cStar__Nom__SRC50__phjet_m_obs_intersection9);
