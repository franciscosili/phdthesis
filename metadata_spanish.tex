...
%---------------------------------------------------
\newcommand{\myTitle}{Fotones iluminando lo desconocido}
% use surd as ASCII sqrt symbol in case needed and fix title separately

\newcommand{\mySubtitle}{B\'usqueda de resonancias de alta masa en estados finales de \(\gamma\)+jet}
...
\newcommand{\myDegree}{Doctorado en Ciencias Físicas\xspace}
\newcommand{\myName}{Francisco \textsc{Sili}\xspace}
\newcommand{\myProf}{Dra. Maria Teresa \textsc{Dova}\xspace}
\newcommand{\myOtherProf}{Dr. Francisco \textsc{Alonso}\xspace}
\newcommand{\mySupervisor}{Dra. Maria Teresa \textsc{Dova}\\Dr. Francisco \textsc{Alonso}\xspace}
\newcommand{\myDepartment}{\href{https://www.fisica.unlp.edu.ar}{Departamento de Física\xspace}}
