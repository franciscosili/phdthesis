...
\part{New Physics}
\input{Chapters/4_new_physics/1_strategy_motivation.tex}
\input{Chapters/4_new_physics/2_samples.tex}
\input{Chapters/4_new_physics/3_event_selection.tex}
\input{Chapters/4_new_physics/4_bkg_estimation.tex}
\input{Chapters/4_new_physics/5_bkg_modeling.tex}
\input{Chapters/4_new_physics/6_systematics.tex}
\input{Chapters/4_new_physics/7_statistical_analysis.tex}
\input{Chapters/4_new_physics/8_results.tex}
